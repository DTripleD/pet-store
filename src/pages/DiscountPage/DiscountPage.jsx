...
import css from "./DiscountPage.module.scss";
import { useEffect, useState } from "react";
import { getPriceLine } from "src/helpers/getPriceLine";
import { getDiscounts } from "../../redux/products/productsOperations";
...
const DiscountPage = ({ animalId, productsId }) => {
  ...
  return (
    <div className={css.wrapper}>
      <div className="container">
        ...
        <h2 className={css.catalogTitle}>Акції</h2>
